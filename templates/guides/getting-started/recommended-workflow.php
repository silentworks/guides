...
<div class="left-col">
	...
	<div class="justify">
		<p>Do what you do best–code. Let's be honest, you are a developer, and development is cool. The thought of configuring a firewall, router, fail-over environment, and general package installation—let’s face it—isn’t that cool. Sure, you've got your Linux merit badge and you're pretty good at it, but that isn't what makes you tick. Focus on your code. Add revisions and features, then collaborate with your developer buddies. Re-format the LAMP configuration sector of your brain and re-fill it with coding awesomeness.</p>
	</div>
	<h2 id="-git">Git</h2>
	<div class="justify">
	...
	<div class="justify">
		<p>Once you've committed the perfect revision, you can deploy that snapshot to all clones simultaneously with the click of a button in the admin panel, or by a simple console command. Within seconds your changes will be live. If by chance your code wasn't quite ready, feel free to rollback and watch your live app recover within seconds.</p>
	</div>
</div>
