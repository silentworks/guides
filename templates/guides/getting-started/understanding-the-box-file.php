{% extends "guides/getting-started/getting-started.php" %}
...
<div class="left-col">
	...
	<div class="justify">
		...
		<h3 class="tag"><span class="guides-sprite cap-notice"></span><span class="horizontal-guides-sprite title">PHP</span><span class="horizontal-guides-sprite red">Sample Login Function</span><span class="guides-sprite red-end-cap"></span></h3>
		<div class="code-block grey">
			public function _onPostLoginResponse ( e:Event ):void {
			    var loader:URLLoader = URLLoader(e.target);
