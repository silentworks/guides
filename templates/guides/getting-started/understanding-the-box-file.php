...
<div class="left-col">
	...
	<div class="justify">
		...
		<ol>
			...
			<li><p>When your app is created, if you specify a framework, a custom tailored .box file will become the new default. At all times, we’ll provide a link to the .box file we are using as your default.</p></li>
		</ol>
	</div>
