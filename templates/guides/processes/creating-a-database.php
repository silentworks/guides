...
<div class="left-col">
	...
	<p>What database model you use is completely depends on your preferen e. Currently, Pagoda Box allows the creation of MySQL databases, but MongoDB is in the works. Others will also be available in the future. Simply select what type of database you would like to use.</p>
	...
	<p>Once you’ve defined your database resources, clicking “Create this Database.” will start the process the process of building your dataabase. </p>
