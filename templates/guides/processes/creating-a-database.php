...
<div class="left-col">
	...
	<p>What database model you use completely depends on your preference. Currently, Pagoda Box allows the creation of MySQL databases, but MongoDB is in the works. Others will also be available in the future. Simply select what type of database you would like to use.</p>
